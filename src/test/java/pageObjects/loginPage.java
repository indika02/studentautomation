...
public class loginPage extends ActionCommands {
    ...
    private By loginErrorMessage=By.xpath("//*[@id=\"root\"]/div[1]/ol/li/div/div[2]");
    ...
    public void verifyTheErrorMessageAsInvalidCredentials(String text) {
        waitTime(driver, loginErrorMessage);
        verifyText(driver, loginErrorMessage, text);
    }
